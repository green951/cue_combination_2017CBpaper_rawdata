function [outputx outputz]=CoordinateTransform(respx,respz,targx,targz)
...
for i=1:r  % this works and I can tell how it works, first do the transaltion and then do the rotation
    ...
    angle1=radial2degree(atan2(respz_prime-0,respx_prime-0));
    
    ang_targ=radial2degree(atan2(targz(i)-0,targx(i)-0));
